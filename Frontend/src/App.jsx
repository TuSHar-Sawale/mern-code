...
const App = () => {
	...
	useEffect(() => {
		...
		axios.get('https://mern-code-2.onrender.com/api/events')
	...
	const handleEventDelete = (id) => {
		...
		// Delete an event
		axios.delete("https://mern-code-2.onrender.com/api/events")
			.then(
				() =>
	...
	const handleToggleReminder = (eventId) => {
		...
		axios.put("https://mern-code-2.onrender.com/api/events", updatedEvent)
			.then(response => {
	...
	const onEventEdit = (eventId, updatedData) => {
		// Update the event in the database
		axios.put("https://mern-code-2.onrender.com/api/events", updatedData)
			.then(response => {
				// If the update is successful, update the events in the state
				const updatedEvents = events.map(event =>
					event._id ===
